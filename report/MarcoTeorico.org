...
*** TODO (EXPLAYAR MAS) Inicialización de pesos
...
*** TODO (breve explicacion de por que funciona el dropout (varias redes neuronales al mismo tiempo, inspiracion biologica)) Evitando el sobre-ajuste: Regularización y Dropout
