...
**** TODO \textit{Slow Feature Analysis} y Automovimiento
...
En la Tabla \ref{ALGUNA TABLA} se puede observar la tasa de error
obtenida mediante la transferencia de aprendizaje con 100, 300, 1000 y
10000 imágenes.
