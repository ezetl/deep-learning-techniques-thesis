...
**** TODO Investigar como guardar multiples etiquetas por imagen (traslacion y rotacion)
...
*** [0%] Entrenamiento
**** TODO Armar la red (.prototxt) teniendo en cuenta el Slice, los multiple Softmax y loss
