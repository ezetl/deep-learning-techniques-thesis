...
**** TODO Entrenar egomotion con swap entre LRN y pooling (como estan en AlexNet original)
**** TODO Crear dataset para SFA
**** TODO Entrenar SFA
...
***** TODO Preprocesar SUN: crop por el centro con dimension mas chica
***** TODO Crear LMDBS SUN. Utilizar solo 3 splits, como en el paper. Crea un LMDB para cada split
...
Por ejemplo, con filters_conv1_kitti_egomotion_213iters.png  y filters_conv1_kitti_egomotion_2307iters.png, ya se empiezan a ver algunas diferencias (filtros que empiezan a detectar algun color especifico por ejemplo).
