...
Como se muestra en la Figura Hay tres tipos de rectificadores lineales:
...
#+attr_latex: width=0.8\textwidth,placement=[p]
#+label: fig:relu
#+caption: Los tres tipos mas comunes de rectificadores lineales: \textit{ReLU}, \textit{Leaky ReLU} y \textit{Maxout}
