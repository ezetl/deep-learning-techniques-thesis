...
** TODO Funciones de activación comunes
*** Sigmoide
*** Tanh
*** ReLU
*** Leaky ReLU
...
cuenta aspectos referidos al preprocesamiento de los datos, como inicializar los pesos, que función de pérdida se va a
utilizar y que métodos de regularización se van a utilizar.
