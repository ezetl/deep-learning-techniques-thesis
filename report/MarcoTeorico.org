...
*** TODO Agregar docs para lo que falta de preprocessing (sun, kitti) 
...
*** TODO Guardar resultados con npy.save. Cargar los archivos si existen para evitar reentrenar todo si se corto un entrenamiento 
*** TODO Agregar experimentos de AlexNet con 20k y 1m de imagenes de Imagenet para SUN397
