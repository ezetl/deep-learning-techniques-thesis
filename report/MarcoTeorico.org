...
pero se cuenta con otro tipo de informacion, hablamos de aprendizaje
no supervisado. Por ejemplo, si se contara con una lista de casas con
sus respectivos precios, su area en metros cubicos y cantidad de
habitaciones y se quisiera encontrar alguna relacion entre ellas. Los
algoritmos no supervisados trabajan netamente sobre los datos
\textit{tal como estan}.
