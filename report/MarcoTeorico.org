...
**** TODO [#B] Entrenar egomotion con swap entre LRN y pooling (como estan en AlexNet original)
**** TODO Crear dos lmdbs: una para las imagenes y otra para los labels (guardados como data y luego spliteados).
