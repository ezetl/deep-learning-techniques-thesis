...
**** TODO Probar swapeando orden en los pares de imagenes (1. modificada, 2. original) uniformemente.
...
**** TODO Probar con los mismos settings que AlexNet(stride, group, etc). Ademas, la parte from scratch no usa preentrenamiento
*** Evaluación
