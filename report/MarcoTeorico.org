...
*** TODO [75%] Hacer las redes programatically, para poder automatizar los entrenamientos
**** DONE Egomotion para kitti y mnist, alexnet 
**** TODO SFA para kitti y mnist
**** DONE Standar para kitti
**** DONE Standar para mnist
*** TODO [57%] Completar el pipeline de entrenamiento en Python:
**** DONE crear nets
**** DONE solver
**** DONE entrenar
**** DONE finetunear
**** TODO testear. Esta hecho el test dentro del train. Hacer una funcion nueva solo para testear
**** TODO guardar best snapshot, no usar siempre el ultimo
**** TODO Armar todos los entrenamientos para MNIST. Crear clase Experiment que permita agregar: preentrenamiento, finetuning, testing
**** TODO mostar resultados
...
*** TODO Hacer test al finalizar entrenamiento, imprimir en pantalla log.
*** TODO Guardar logs de cada entrenamiento
** Datasets
