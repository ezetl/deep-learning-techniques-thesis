...
introduciremos lo que son las redes neuronales para terminar en \dl y
redes siamesas.

** Clasificadores lineales
Vamos a encarar el problema de clasificación de imágenes de una manera paramétrica
