...
Una vez entrenadas las redes siamesas es común elegir alguna de sus
redes por separado (da lo mismo cual sea pues comparten los mismos
parámetros) y utilizarla para aplicar transferencia de aprendizaje a
un nuevo problema. De esta manera se aprovechan los parámetros
aprendidos y es posible entrenar con menos datos.
...
adentrar en trabajo de Agrawal et al. \cite{LSM2015} con redes
siamesas, reproduciendo y analizando sus resultados en lo que conforma
el eje principal de este trabajo final.
