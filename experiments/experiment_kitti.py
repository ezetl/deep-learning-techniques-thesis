    ...
    for output in outputs_to_test:
        ...
        for num in sizes_lmdb:
            ...
            for split in splits:
                ...
                # CONTRASTIVE m=10
                snapshot_prefix = 'snapshots/kitti/contrastive10_finetuning/kitti_lmdb{}'.format(num)
                ...
                # Contrastive m=100
                snapshot_prefix = 'snapshots/kitti/contrastive100_finetuning/kitti_lmdb{}'.format(num)
                ...
                #Imagenet 20
                snapshot_prefix = 'snapshots/kitti/imagenet20_finetuning/kitti_lmdb{}'.format(num)
                ...
                #Imagenet 1000
                snapshot_prefix = 'snapshots/kitti/imagenet1000_finetuning/kitti_lmdb{}'.format(num)
